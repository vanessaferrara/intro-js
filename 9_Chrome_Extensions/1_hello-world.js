...
// Add to the manifest the background script "background.js" copying
// the snippet below:
...
// Oooops. There is an intentional typo in the snippet above:

// "backround" is missing a "g". It is an easy fix, but could you
//  visualize the error message on the Chrome extensions page? 

// Checkpoint.
// 1 - How can you visualize the output of a background script?
